...
| [0044](0044-distillation-and-external-source-validation-2026-06-23.md) | Distillation and external-source validation pass (2026-06-23): re-derives the system from the code and governance spine and validates the load-bearing external claims against their trusted sources (MCP `2025-11-25` spec current; RFC 6962 Merkle correct; CRA dates current; EU AI Act high-risk dates drifted and corrected for the Digital Omnibus deferral, flagged provisional pending the Official Journal, BL-113); roadmap MCP spec URLs moved to the dated stable path; no code change | Accepted |
