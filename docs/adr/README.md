...
| [0025](0025-ssrf-rebinding-aware-resolution-2026-06-14.md) | Rebinding-aware SSRF egress resolution (2026-06-14): additive `resolve_and_assert_egress_allowed` that resolves a host, checks every resolved IP, and returns the pinned address; strict deny-names default unchanged; wiring deferred to the first egress consumer (BL-046 resolver delivered; wiring open) | Accepted |
